...
const { Component } = require("react"),
    ...
    ipcErr = require("app/all/ipc-error.js");
...
class App extends Component {
    ...
    */
    componentDidMount() {
        this._elem.addEventListener("app-open-file", this.onOpenFile);
    ...
    */
    componentWillUnmount() {
        ...
        this._elem.removeEventListener("app-open-file", this.onOpenFile);
    ...
    */
    ...
    /* Open file handler.
        ...
        e - Open file event.
    */
    onOpenFile = async (event) => {
        ipc.send("open-file", "browser");
    };
    
    /* IPC 'loaded-file' listener.

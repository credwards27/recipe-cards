...
class Recipe {
    ...
    */
    ...
    /* Setter for _prep.
        ...
        time - See Recipe._setTime().
    */
    set prep(time) {
        this._setTime("_prep", time);
    }
    ...
    */
    ...
    /* Sets a time value for the recipe.
        
        time - Number in minutes, or custom string to display as-is.
    */
    _setTime(prop, time) {
        if (prop !== "_prep" && prop !== "_cook") {
            return;
        }

...
class IngredientsCard extends Card {
    ...
    */
    getAuthorDom(author) {
        ...
        let possessive = author.match(/s$/i) ? "" : "s";
        
        author += `${String.fromCharCode(8217)}${possessive}`;
        
        return (
            <h3 className="col-12">{`${author} Recipe`}</h3>
        );
    }
    ...
    */
    render() {
        let author = this.getAuthorDom(this.props.author),

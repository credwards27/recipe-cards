...
class LinkedList {
    ...
    */
    ...
    /* Pushes an item to the end of the list.
        ...
        Returns the new node containing the appended data.
    */
    push(data) {
    ...
    */
    unshift(data) {
        return this.insert(data, this[this._start]);
    }
    ...
    */
    ...
    /* Removes a node object from the list.
        ...
        destroy - True to destroy the node after removing it (other references
            to the node object may still need to be manually removed), false to
            return it. Defaults to true.
        
        Returns the removed node if destroy is true, or the node's data if
        destroy is false.
    */
